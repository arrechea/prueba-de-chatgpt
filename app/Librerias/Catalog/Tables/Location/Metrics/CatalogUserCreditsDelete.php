...
class CatalogUserCreditsDelete extends LibCatalogoModel
{
    use CreditsUserRelations;
    ...
    public function Valores(Request $request = null)
    {
        ...
        return [
            ...
            (new LibValoresCatalogo($this, __('credits.deleted'), 'deleted', [
                'validator' => '',
            ])),
        ];
    }
