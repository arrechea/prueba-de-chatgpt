...
class CatalogMailsPurchases extends LibCatalogoModel
{
    ...
    public function Valores(Request $request = null)
    {
        return [
            ...
            new LibValoresCatalogo($this, __('mails.giftcardsText'), 'giftcards_text', [
                'validator'    => 'string|nullable',
                'hiddenInList' => true,
            ]),
        ];
    ...
    {
        return route('admin.company.brand.mails.mail-purchse.create', [
