...
class CatalogMailsSubscriptionError extends LibCatalogoModel
{
    use MailsRelations, TraitConImagen, SoftDeletes;
    protected $table = 'mails_subscriptions_payments_failed';

    public function GetName()
    {
        return 'mails_subscriptions_payments_failed';
    }
    ...
    public function Valores(Request $request = null)
    {
        return [
            ...
            new LibValoresCatalogo($this, __('mails.tittle'), 'title', [
                'validator'    => 'string|nullable',
                'hiddenInList' => true,
            ]),

            new LibValoresCatalogo($this, __('mails.description'), 'description', [
                'validator'    => 'string|nullable',
                'hiddenInList' => true,
            ]),
        ];
    ...
    {
        return route('admin.company.brand.mails.subscription-error.edit', [
