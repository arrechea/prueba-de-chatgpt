...
<form action="{{$urlForm}}" class="row" autocomplete="off" method="post" enctype="multipart/form-data">
    ...
    @if(isset($waitlistConfirm))
        <input type="hidden" name="id" value="{{$waitlistConfirm->id}}">
    @endif
    {{csrf_field()}}
                ...
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="logo_link" id="logo_link"
                               value="{{old('logo_link', (isset($waitlistConfirm) ? $waitlistConfirm->logo_link: ''))}}">
                        <label for="logo_link">{{__('mails.logoLink')}}</label>
                    </div>
                </div>
                <div class="col s12 m12 l7">
                    <div class="input-field">
                        <input type="text" class="input" name="thank_message" id="thank_message"
                               value="{{old('thank_message', (isset($waitlistConfirm) ? $waitlistConfirm->thank_message: ''))}}">
                        <label for="thank_message">{{__('mails.thankMessage')}}</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col s12 m12 card-panel panelcombos">
                ...
                <div class="col s12 m12 l12">
                    <div class="file-field input-field">
                        <div class="uploadPhoto">
                            <img src="{{$waitlistConfirm->logo??''}}" width="180px" alt=""
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="file-field input-field">
                        <div class="uploadPhoto">
                            <img src="{{$waitlistConfirm->background_img??''}}" width="180px" alt=""
                                 class="responsive-img uploadPhoto--image"/> <br>
                            <h5 class="header"><i
