...
<form action="{{$urlForm}}" class="row" autocomplete="off" method="post" enctype="multipart/form-data">
    ...
    @if(isset($subscriptionConfirm))
        <input type="hidden" name="id" value="{{$subscriptionConfirm->id}}">
    @endif
    {{csrf_field()}}
                ...
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="confirmation_text" id="confirmation_text"
                               value="{{old('confirmation_text', (isset($subscriptionConfirm) ? $subscriptionConfirm->confirmation_text: ''))}}">
                ...
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="logo_link" id="logo_link"
                               value="{{old('logo_link', (isset($subscriptionConfirm) ? $subscriptionConfirm->logo_link: ''))}}">
        ...
        <div class="col s12 m12 card-panel panelcombos">
                ...
                <div class="col s12 m12 l12">
                    <div class="file-field input-field">
                        <div class="uploadPhoto">
                            <img src="{{$subscriptionConfirm->logo??''}}" width="180px" alt=""
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="file-field input-field">
                        <div class="uploadPhoto">
                            <img src="{{$subscriptionConfirm->background_img??''}}" width="180px" alt=""
                                 class="responsive-img uploadPhoto--image"/> <br>
                            <h5 class="header"><i
