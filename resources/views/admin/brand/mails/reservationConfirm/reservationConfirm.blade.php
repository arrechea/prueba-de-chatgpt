...
<form action="{{$urlForm}}" class="row" autocomplete="off" method="post" enctype="multipart/form-data">
    ...
    @if(isset($reservationConfirm))
        <input type="hidden" name="id" value="{{$reservationConfirm->id}}">
    @endif
    {{csrf_field()}}
                ...
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="logo_link" id="logo_link"
                               value="{{old('logo_link', (isset($reservationConfirm) ? $reservationConfirm->logo_link: ''))}}">
                ...
                <div class="col s12 m12 l7">
                    <div class="input-field">
                        <input type="text" class="input" name="reservation_link" id="reservation_link"
                               value="{{old('reservation_link', (isset($reservationConfirm) ? $reservationConfirm->reservation_link: ''))}}">
        ...
        <div class="col s12 m12 card-panel panelcombos">
                ...
                <div class="col s12 m12 l12">
                    <div class="file-field input-field">
                        <div class="uploadPhoto">
                            <img src="{{$reservationConfirm->logo??''}}" width="180px" alt=""
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="file-field input-field">
                        <div class="uploadPhoto">
                            <img src="{{$reservationConfirm->background_img??''}}" width="180px" alt=""
                                 class="responsive-img uploadPhoto--image"/> <br>
                            <h5 class="header"><i
