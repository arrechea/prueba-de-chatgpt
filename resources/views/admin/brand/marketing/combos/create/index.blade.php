        ...
        <div class="BuqSaas-l-form">
            <div class="BuqSaas-l-form__header">
               ...
               <div class="BuqSaas-c-sectionTitle">
                  <h2>{{__('marketing.Create')}} {{__('marketing.Combos')}}</h2>
               </div>
            </div>
            <div class="BuqSaas-l-form__body">
                @include('admin.brand.marketing.combos.formcombo')
            </div>
        </div>
        @else
            @include('admin.brand.marketing.tabs')
            <div class="row">
                <div class="card-panel radius--forms"><h5 class="header">{{__('marketing.Create')}} {{__('marketing.Combos')}}</h5>
                    @include('admin.brand.marketing.combos.formcombo')
                </div>
            </div>
        @endif
