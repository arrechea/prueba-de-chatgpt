        ...
        <div class="BuqSaas-l-list">
            <div class="BuqSaas-l-list__header">
                <div class="BuqSaas-c-sectionTitle">
                    <h2>Paquetes de: <strong>{{($brand->name)}}</strong></h2>
                </div>
                <div class="BuqSaas-c-nav is-list">
                    ...
                    <div class="BuqSaas-c-nav__add">
                        <a
                            ...
                            href="{{route('admin.company.brand.marketing.combos.create', [
                            'company' => $company,
                            'brand'   => $brand,
                            ])}}">
            ...
            <div class="BuqSaas-l-list__body is-marketingCombos">
        ...
        @include('admin.brand.marketing.tabs')
            <div class="row">
                <div class="card-panel radius--forms">
                    <h5 class="header">{{__('marketing.Combos')}}</h5>
                    <p>
