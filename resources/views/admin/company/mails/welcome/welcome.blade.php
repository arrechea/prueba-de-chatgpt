...
<form action="{{$urlForm}}" class="row" autocomplete="off" method="post" enctype="multipart/form-data">
    ...
    @if(isset($welcomeEdit))
        <input type="hidden" name="id" value="{{$welcomeEdit->id}}">
    @endif
    {{csrf_field()}}
    ...
    <div class="col s12 m8">
        ...
        <div class="card-panel panelcombos">
            <div class="row">
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="logo_link" id="logo_link"
                               value="{{old('logo_link', (isset($welcomeEdit) ? $welcomeEdit->logo_link: ''))}}"
                               required>
                ...
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="correct_url" id="correct_url"
                               value="{{old('correct_url', (isset($welcomeEdit) ? $welcomeEdit->correct_url: ''))}}"
                               required>
                        <label for="correct_url">{{__('mails.correctUrl')}}</label>
                    </div>
                </div>
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="incorrect_url" id="incorrect_url"
                               value="{{old('incorrect_url', (isset($welcomeEdit) ? $welcomeEdit->incorrect_url: ''))}}"
                               required>
                        <label for="incorrect_url">{{__('mails.incorrectUrl')}}</label>
                    </div>
                </div>
            </div>
                ...
                <div class="col s12 m12 l6">
                    <div class="input-field">
                        <input type="text" class="input" name="text_1" id="text_1"
                               value="{{old('text_1', (isset($welcomeEdit) ? $welcomeEdit->text_1: ''))}}">
                ...
                <div class="col s12 m12 l10">
                    <div class="input-field">
                        ...
                        <textarea class="materialize-textarea" name="text_2"
                                  id="text_2">{{old('text_2', (isset($welcomeEdit) ? $welcomeEdit->text_2: ''))}}</textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col s12 m4">
        ...
        <div class="card-panel panelcombos">
            <div class="row">
                <div class="file-field input-field">
                    <div class="uploadPhoto">
                        <img src="{{$welcomeEdit->logo??''}}" width="180px" alt=""
            ...
            <div class="row">
                <div class="file-field input-field">
                    <div class="uploadPhoto">
                        <img src="{{$welcomeEdit->background_img??''}}" width="180px" alt=""
                             class="responsive-img uploadPhoto--image"/> <br>
                        <h5 class="header"><i
