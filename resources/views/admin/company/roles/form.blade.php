...
@section('jsPostApp')
    ...
    <script>
        window.Roles = {
            urls: {
                company: "{{route('admin.company.roles.companies',['company'=>$company])}}",
                brandsLocations: "{{route('admin.company.roles.brandsLocations',['company'=>$company])}}",
            },
            lang: {
    ...
    <div style="display: none" id="EditRoles--companyEditable">true</div>
