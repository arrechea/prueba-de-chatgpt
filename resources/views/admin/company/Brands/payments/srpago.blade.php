<div
    ...
    <div class="col s12">
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m12">
                <input type="text" id="development_publishable_key{{$slug}}"
                       name="methods[{{$slug}}][config][development_publishable_key]"
                       value="{{old('methods['.$slug.'][config][development_publishable_key]',$settings['development_publishable_key'] ?? '' )}}">
                <label for="private_api_key_{{$slug}}">{{__('company.DevelopmentPublishableKey')}}</label>
            </div>
        </div>
        {{--Production--}}
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m12">
                <input type="text" id="production_publishable_key{{$slug}}"
                       name="methods[{{$slug}}][config][production_publishable_key]"
                       value="{{old('methods['.$slug.'][config][production_publishable_key]',$settings['production_publishable_key'] ?? '' )}}">
                <label for="production_private_api_key_{{$slug}}">{{__('company.ProductionPublishableKey')}}</label>
            </div>
        </div>
    </div>
</div>
