        ...
        <ul>
            ...
            @if(\App\Librerias\Permissions\LibPermissions::userCan(Auth::user(),\App\Librerias\Permissions\LibListPermissions::RESERVATION_VIEW, $location))
                <li><a
                    ...
                    class="BuqSaas-e-button is-tab {{(Route::current()->getName()==='admin.company.brand.locations.reservations.users.index' ? 'active' : '')}}">{{__('reservations.ListUsers')}}</a>
                </li>
            @endif
            ...
            @if(\App\Librerias\Permissions\LibPermissions::userCan(Auth::user(),\App\Librerias\Permissions\LibListPermissions::STAFF_VIEW, $location))
                <li><a
                    ...
                    class="BuqSaas-e-button is-tab {{(Route::current()->getName()==='admin.company.brand.locations.reservations.staff.index' ? 'active' : '')}}">{{__('reservations.ListStaff')}}</a>
                </li>
            @endif
            ...
            @if(\App\Librerias\Permissions\LibPermissions::userCan(Auth::user(),\App\Librerias\Permissions\LibListPermissions::ROOMS_VIEW, $location))
                <li><a
                    ...
                    class="BuqSaas-e-button is-tab {{(Route::current()->getName()==='admin.company.brand.locations.reservations.room.index' ? 'active' : '')}}">{{__('reservations.ListRoom')}}</a>
                </li>
            @endif
        </ul>
    {{--  </div>
